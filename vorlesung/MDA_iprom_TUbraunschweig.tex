...
%
\fancyfoot[LE,RO]{MDA, WS 2019/20, Version: \the\day .\the\month .\the\year}
...
\chapter{Beispiele zum GUM}

\chapter{Monte-Carlo Methoden}
\include{10_vorlesung/10_MonteCarloMethoden}

\chapter{Beispiele zu Monte-Carlo-Methoden nach GUM-S1}
...
%    https://www.bipm.org/utils/common/documents/jcgm/JCGM\_101\_2008\_E.pdf
    ...
    \bibitem[Rao09]{Rao09} S.S. Rao: Egineering optimization: theory and practice,
    ...
    \bibitem[Wiki02]{Wiki02} https://en.wikipedia.org/wiki/Gauss-Newton\_algorithm
        \bibitem[Sat41]{Sat41} F.E. Satterthwaite: Synthesis of variance.
