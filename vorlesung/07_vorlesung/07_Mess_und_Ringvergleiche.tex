...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=150mm]{07_vorlesung/media/StandardScore.png}
...
Statistisch wird dies damit ausgedrückt, dass die Stichproben aus den verschiedenen
Laboren zu verschiedenen Grundgesamtheiten gehören.
Konkret bedeutet das, dass für die Gewichte zusätzlich zur Varianz des Mittelwerts
...
\textsl{between group variability}) eingeführt wird.
...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=120mm]{07_vorlesung/media/PauleMandel.pdf}
